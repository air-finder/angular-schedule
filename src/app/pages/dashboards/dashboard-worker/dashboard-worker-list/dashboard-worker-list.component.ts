...
@Component({
  selector: 'app-dashboard-worker-list',
  imports: [
    CardComponent,
    IconButtonComponent,
    IconComponent,
  ...
  templateUrl: './dashboard-worker-list.component.html',
  styleUrl: './dashboard-worker-list.component.scss'
})
export class DashboardWorkerListComponent {
